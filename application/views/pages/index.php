					...
					<div class="container">
						...
						<div class="row">
							<div class="col-md-3 col-sm-6">
								<div class="news">
									<image class="news-image" src="<?=base_url();?>design/images/news-thumb-1.jpg"></image>
							...
							<div class="col-md-3 col-sm-6">
								<div class="news">
									<image class="news-image" src="<?=base_url();?>design/images/news-thumb-2.jpg"></image>
									<h3 class="news-title"><a href="#">laboris nisi ut aliquip</a></h3>
									<small class="date"><i class="fa fa-calendar"></i>24 mar 2014</small>
								</div>
							</div>
							<div class="col-md-3 col-sm-6">
								<div class="news">
									<image class="news-image" src="<?=base_url();?>design/images/news-thumb-3.jpg"></image>
									<h3 class="news-title"><a href="#">laboris nisi ut aliquip</a></h3>
									<small class="date"><i class="fa fa-calendar"></i>24 mar 2014</small>
								</div>
							</div>
							<div class="col-md-3 col-sm-6">
								<div class="news">
									<image class="news-image" src="<?=base_url();?>design/images/news-thumb-4.jpg"></image>
									<h3 class="news-title"><a href="#">laboris nisi ut aliquip</a></h3>
									<small class="date"><i class="fa fa-calendar"></i>24 mar 2014</small>
								</div>
							</div>
						...
						<div class="row">
							...
							<div class="col-md-6">
								...
								<ul class="seremon-list">
									<li>
										<img src="<?=base_url();?>design/images/small-thumb-1.jpg" alt="">
									...
									<li>
										<img src="<?=base_url();?>design/images/small-thumb-2.jpg" alt="">
										<div class="seremon-detail">
									...
									<li>
										<img src="<?=base_url();?>design/images/small-thumb-3.jpg" alt="">
										<div class="seremon-detail">
